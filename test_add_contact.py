...
class TestAddContact(unittest.TestCase):
    ...
    def create_contact(self, driver):
        ...
        driver.find_element_by_name("middlename").send_keys("sdbdbsdbs")
        driver.find_element_by_name("lastname").click()
        driver.find_element_by_name("lastname").clear()
        driver.find_element_by_name("lastname").send_keys("sdbsddbs")
        driver.find_element_by_name("nickname").click()
        driver.find_element_by_name("nickname").clear()
        driver.find_element_by_name("nickname").send_keys("dsbsbdds")
        driver.find_element_by_name("title").click()
        driver.find_element_by_name("title").clear()
        driver.find_element_by_name("title").send_keys("sdbdsbbd")
        driver.find_element_by_name("company").click()
        driver.find_element_by_name("company").clear()
        driver.find_element_by_name("company").send_keys("dsbsdbsb")
        ...
        driver.find_element_by_name("mobile").send_keys("7214651645")
        ...
        driver.find_element_by_name("email2").send_keys("jwfkqjfkqjwfl@mail.ru")
        ...
        driver.find_element_by_name("phone2").send_keys("vsdsvdsvd")
